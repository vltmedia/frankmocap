...
curl.exe -o ../extra_data/body_module/body_pose_estimator/checkpoint_iter_370000.pth https://download.01.org/opencv/openvino_training_extensions/models/human_pose_estimation/checkpoint_iter_370000.pth
